      ...
      <Box sx={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", p: 2 }}>
        <Card variant="outlined" sx={{ width: "100%", maxWidth: 380 }}>
          <CardContent sx={{ p: 4, display: "flex", flexDirection: "column", gap: 2 }}>
            <Typography variant="h5" sx={{ fontWeight: 'bold' }}>Revisá tu email</Typography>
    ...
    <Box sx={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", p: 2 }}>
      <Card variant="outlined" sx={{ width: "100%", maxWidth: 380 }}>
        <CardContent sx={{ display: "flex", flexDirection: "column", gap: 3, p: 4 }}>
          <Box>
            <Typography variant="h5" sx={{ fontWeight: 'bold' }}>Crear cuenta</Typography>
            <Typography variant="body2" color="text.secondary">Registrate para guardar tus recetas</Typography>
          </Box>
